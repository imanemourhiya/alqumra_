        ...
        <div className="footer__grid">
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              ...
              <li><Link to="/profile?tab=bookings">{t('myBookings')}</Link></li>
              <li><Link to="/profile">{t('loyaltyCard')}</Link></li>
              <li><Link to="/profile?tab=bookings">Revendre un ticket</Link></li>
              <li><Link to="/feedback">Donner mon avis</Link></li>
            </ul>
          </div>
